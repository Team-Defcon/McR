package superscary.mcr.gui.menu;
...
public class ChemicalMixerMenu extends AbstractContainerMenu
{
    ...
    public final ChemicalMixerEntity blockEntity;
    ...
    public ChemicalMixerMenu (int id, Inventory inv, BlockEntity entity, ContainerData data)
    {
        ...
        blockEntity = (ChemicalMixerEntity) entity;
        this.level = inv.player.level;
        this.data = data;
        this.inputFluidStack = blockEntity.getInputFluidStack();
        this.outputFluidStack = blockEntity.getOutputFluidStack();
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 69, 15));
            this.addSlot(new SlotItemHandler(handler, 2, 126, 15));
            this.addSlot(new SlotItemHandler(handler, 3, 126, 60));
        });
    ...
    public void setOutputFluidStack (FluidStack fluidStack)
    {
    ...
    {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, McRBlockReg.CHEMICAL_MIXER.get());
    }
