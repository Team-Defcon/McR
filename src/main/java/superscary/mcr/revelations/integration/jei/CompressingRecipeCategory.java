...
public class CompressingRecipeCategory implements IRecipeCategory<CompressorRecipe>
{
    ...
    public static final ResourceLocation UID = new ResourceLocation(Revelations.MODID, "compress");
    public static final ResourceLocation TEXTURE = new ResourceLocation(Revelations.MODID, "textures/gui/compressor_gui.png");
