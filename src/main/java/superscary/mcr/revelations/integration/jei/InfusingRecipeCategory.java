...
public class InfusingRecipeCategory implements IRecipeCategory<InfuserRecipe>
{
    ...
    public static final ResourceLocation UID = new ResourceLocation(Revelations.MODID, "infusing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(Revelations.MODID, "textures/gui/infuser_gui.png");
