...
public class ElectricFurnaceRecipeCategory implements IRecipeCategory<SmeltingRecipe>
{
    ...
    public static final ResourceLocation UID = new ResourceLocation(Revelations.MODID, "smelting");
    public static final ResourceLocation TEXTURE = new ResourceLocation(Revelations.MODID, "textures/gui/electric_furnace_gui.png");
