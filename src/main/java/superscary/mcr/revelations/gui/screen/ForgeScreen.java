...
public class ForgeScreen extends AbstractContainerScreen<ForgeMenu>
{
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Revelations.MODID, "textures/gui/forge_gui.png");
    ...
    private void assignEnergyInfoArea ()
    {
        ...
        energyInfoArea = new EnergyInfoArea(x + 10 ,y + 12, menu.blockEntity.getEnergyStorage(), 8, 74);
    }
    ...
    private void renderEnergyAreaTooltips (PoseStack pPoseStack, int pMouseX, int pMouseY, int x, int y)
    {
        ...
        if (isMouseAboveArea(pMouseX, pMouseY, x, y, 10, 12, 8, 74))
        {
    ...
    protected void renderBg (@NotNull PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY)
    {
        ...
        blit(pPoseStack, x, y, 0, 0, imageWidth, 176);

        FormattedCharSequence formattedcharsequence = menu.blockEntity.getDisplayName().getVisualOrderText();
        Font f = Minecraft.getInstance().font;
        Minecraft.getInstance().font.draw(pPoseStack, formattedcharsequence, (float) (x - f.width(formattedcharsequence) / 2) + 88, y + 3, 0x555555);
