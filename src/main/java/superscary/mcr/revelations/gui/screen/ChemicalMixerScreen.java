...
import superscary.mcr.revelations.gui.renderer.FluidTankRenderer;
...
public class ChemicalMixerScreen extends AbstractContainerScreen<ChemicalMixerMenu>
{
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(Revelations.MODID, "textures/gui/chemical_mixer_gui.png");
