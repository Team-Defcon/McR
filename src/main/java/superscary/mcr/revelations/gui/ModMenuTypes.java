package superscary.mcr.revelations.gui;
...
import superscary.mcr.revelations.gui.menu.*;

public class ModMenuTypes
{

    public static final DeferredRegister<MenuType<?>> MENUS = DeferredRegister.create(ForgeRegistries.MENU_TYPES, Revelations.MODID);
    ...
    public static final RegistryObject<MenuType<ForgeMenu>> FORGE_MENU = registerMenuType(ForgeMenu::new, "forge_menu");
