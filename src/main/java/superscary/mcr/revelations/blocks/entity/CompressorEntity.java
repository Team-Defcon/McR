...
import superscary.mcr.revelations.blocks.machine.CompressorBlock;
import superscary.mcr.revelations.gui.menu.CompressorMenu;
...
public class CompressorEntity extends MachineBaseEntity implements MenuProvider
{
    ...
    public static void tick (Level level, BlockPos pos, BlockState state, CompressorEntity pEntity)
    {
    ...
    private static void extractEnergy (CompressorEntity pEntity)
    {
        pEntity.ENERGY_STORAGE.extractEnergy(ENERGY_REQ, false);
    }

    private static boolean hasEnoughEnergy (CompressorEntity pEntity)
    {
    ...
    private static void craftItem (CompressorEntity pEntity)
    {
    ...
    private static boolean hasRecipe (CompressorEntity entity)
    {
    ...
    public CompressorEntity getBlockEntity ()
    {
        return this;
    }
}
